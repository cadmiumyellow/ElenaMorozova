...
public class TrelloBoardJson {
    ...
    public String toString() {
        ...
        sb.append(TrelloBoardJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrelloBoardJson) == false) {
            return false;
        }
        TrelloBoardJson rhs = ((TrelloBoardJson) other);
